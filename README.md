...
_You can also download_ [`DubChords1.0.1.Standalone.AU.VST.zip
`](https://github.com/de0bfusc4tor/Dub-Chords/releases/download/DubChords1.0.1/DubChords1.0.1.Standalone.AU.VST.zip) _with everything inside._
